...
```
Once the repository is cloned and virtual environment set up, go to the directory where the requirements.txt(Cab-allocation-system/backend/) is and type the following code in your terminal:
